...
WORLD_MONITOR_URL = os.getenv("WORLD_MONITOR_URL", "https://worldmonitor.app/")
ENABLE_BROWSER_LAUNCH = os.getenv("ENABLE_BROWSER_LAUNCH", "true").lower() == "true"
...
def register(mcp):
    ...
    async def open_world_monitor() -> str:
        ...
        try:
            ...
            return f"World Monitor is available at {url}"
